<template>
	<el-menu class="side el-menu-vertical-demo" default-active="/" @open="handleOpen" @close="handleClose"
		...
		<el-submenu index="user"
			...
			<el-menu-item index="/division_manager/table" v-show="user_group == '管理员' || $check_action('/division_manager/table')"><span>部门经理</span></el-menu-item>
